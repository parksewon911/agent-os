...
export const navItems = [
  ...
  { to: '/crm', label: '고객 CRM', icon: 'users' },
  { to: '/assistant', label: 'AI 상담 비서', icon: 'bot' },
  { to: '/ocr', label: '증권 OCR·리모델링', icon: 'scan' },
  ...
  { to: '/sns', label: 'SNS 콘텐츠', icon: 'share' },
  { to: '/recruit', label: '리크루팅 CRM', icon: 'recruit' },
  { to: '/team', label: '팀 실적', icon: 'team' },
]
